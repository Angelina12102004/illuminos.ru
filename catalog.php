<?php
	...
	$sql = "SELECT * FROM `products` WHERE `count`  ORDER BY `created_at` DESC";
...
?>
  ...
  <div class="film">
    <h1> movies  </h1>
    <h2>"Soviet films are inspiration and art that will ignite the fire of freedom and hope in you!"  </h2>
    <button>main</button>
  </div>
  <div class="film2">
